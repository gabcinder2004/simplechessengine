...
namespace SimplifiedChessEngine
{
    public abstract class ChessPiece
    {
        ...
        public abstract List<ChessMove> GetAvailableMoves(Cell currentCell, ChessBoard board, int turnNumber, bool protectPiece = true);
        ...
        protected List<ChessMove> GetAvailableMoves(List<Tuple<int, int>> movePattern, Cell currentCell, ChessBoard board, int turnNumber, bool protectQueen)
        {
            ...
            foreach (var pattern in movePattern)
            {
                ...
                while (true)
                {
                    ...
                    if (protectQueen)
                    {
                        var moveInQuestion = new ChessMove(currentCell, newCell, action, currentCell.Piece.Color, turnNumber);
                    ...
                    availableMoves.Add(new ChessMove(currentCell, newCell, action, currentCell.Piece.Color, turnNumber));
